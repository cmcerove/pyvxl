...
def print_help():
    ...
    print '        or   stop syspwrmd'
    print '        or   stop 0x10242040'
    print '  killnode <node>'
    print '     - Stops all periodic messages sent from <node>'
    print '  killall'
    print '     - Stops all periodics'
    print ''
    ...
    print '     - Prints all periodics being sent. If \'info\' is present, signals of each'
    print '       periodic and their values are also printed.'
